...
public class ProXml_DSCLD {
	private final static Logger  log = LoggerFactory.getLogger(ProXml_DSCLD.class);
	/**
	 * 
	 * <p>
	 * 转码
...
//        }
	...
	public static void getGlobalInfo(Map map, GlobalInfo globalInfo) {
        ...
        globalInfo.setDataExchangeId((String) map.get(XmlPar.MAP_KEY_DSPTBM) + (String) map.get(XmlPar.MAP_KEY_YWBM) + ProXml_DSCLD.getCurDate("yyyyMMdd") + getRdom(9));
    }
