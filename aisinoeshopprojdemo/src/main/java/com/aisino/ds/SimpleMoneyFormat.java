...
public class SimpleMoneyFormat {
	...
	private HashMap<String,Object> chineseNumberMap = new HashMap<String,Object>();
	private HashMap<String,Object> chineseMoneyPattern = new HashMap<String,Object>();
	...
	private String addUnitsToChineseMoneyString(String moneyStr) {
		...
		} else if (cMoneyStringBuffer.indexOf("零分") != -1)// 没有零分，不输出零分，也不加整
		{
			...
			if (cMoneyStringBuffer.indexOf("零角") == (cMoneyStringBuffer
					.length() - 4)) {
				cMoneyStringBuffer.replace(cMoneyStringBuffer.indexOf("零角"),
						cMoneyStringBuffer.indexOf("零角") + 2, ZERO);
			} else {
	...
	/*public static void main(String args[]) {
		System.out.println(getInstance().format(new Double(1011)));
	}*/
}
