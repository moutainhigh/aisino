...
//		// 验签
//		boolean isTrue = jSE.verifySign(decrypt_data, signedData, "SHA1/RSA", this.corpCert, "DatechCrypto");
//		// ---------------------------------调用加密机结束---------------------------------
//
//		if (isTrue) {
//			return decrypt_data;
...
//		// ---------------------------------------调用加密机结束---------------------------------------
	 ...
	 * sjutil.encrypt(cleartext.getBytes()); //
	 * System.out.println("encrypt加密成功:"+ new
	 * String(sjutil.encrypt(cleartext.getBytes()))); String strs[] = { "", ""
