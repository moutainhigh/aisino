...
public class InvokeInterfaceTest9 {
...
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣A4正票.txt"), "utf-8");//没有问题 正常开票；
 //           content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣清单正票.txt"), "utf-8");//没有问题 正常开票；
            ...
            content = FileUtils.readFileToString(new File("D:\\test\\jd13.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\jd10.txt"), "utf-8");//没有问题 正常开票；
        ...
        contentString = content.replace(regex, "<FPQQLSH>3"+System.currentTimeMillis()+"</FPQQLSH>");
        String regex1 = "<DDH></DDH>" ;
        contentString = contentString.replace(regex1, "<DDH>3"+System.currentTimeMillis()+"</DDH>");
        String regex2 = "<BZ></BZ>" ;
        contentString = contentString.replace(  regex2, "<BZ>订单号:3"+System.currentTimeMillis()+"</BZ>");
       ...
       /* String requestXml = "<?xml version='1.0' encoding='utf-8' ?>"
                ...
                + "<requestCode>11110101</requestCode>"
                + "<requestTime>2016-7-13 11:33:29</requestTime>"
                + "<responseCode>121</responseCode>"
                + "<dataExchangeId>ECXML.FPKJ.BC.E_INV20171201457001938</dataExchangeId>"
                + "<userName>11110101</userName>"
//				+ "<userName>91110108MA00CX3NXA</userName>"
                + "<passWord>1114761335wSSjuTk0ca6V/crs+k46oA==</passWord>"
                + "<taxpayerId>15000119270105897</taxpayerId>"
//				+ "<taxpayerId>91110108MA00CX3NXA</taxpayerId>"
                ...
                + "</interface>";*/
        String requestXml = "<?xml version='1.0' encoding='UTF-8'?>"
        +"<interface xmlns='' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:schemaLocation='http://www.chinatax.gov.cn/tirip/dataspec/interfaces.xsd' version='DZFP1.0'>"
        +"<globalInfo>"
        +"<terminalCode>1</terminalCode>"
        +"<appId>DZFP</appId>"
        +"<version>2.0</version>"
        ...
        +"<interfaceCode>ECXML.FPKJ.BC.E_INV</interfaceCode>"
        +"<userName>11110101</userName>"
        +"<passWord>8876175052a1valM+vvTJFP9INULK3vA==</passWord>"
        +"<requestCode>11110101</requestCode>"
        +"<requestTime>2017-12-01 06:24:01:663</requestTime>"
        +"<responseCode>121</responseCode>"
        +"<dataExchangeId>ECXML.FPKJ.BC.E_INV20171201648265013</dataExchangeId>"
        +"</globalInfo>"
        +"<returnStateInfo>"
        +"<returnCode />"
        +"<returnMessage />"
...
//        String interfaceUrl = "http://10.1.30.189:8080/zzs_jdProxy/webservice/eInvWS?wsdl";
        ...
        Object[] invokeParam = new Object[] { requestXml };
        String responseXml = InvokeInterfaceTest9.invokeWS(interfaceUrl,
