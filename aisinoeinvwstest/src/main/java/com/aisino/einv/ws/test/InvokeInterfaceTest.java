...
public class InvokeInterfaceTest {
    ...
    public static void main(String[] args) throws IOException {
        String content = "";
        try {
        	content = FileUtils.readFileToString(new File("/Users/fwh/Downloads/jdlp.txt"), "utf-8");//没有问题，正常开票
...
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\京东测试票-test.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\京东测试票.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\京东测试票-红票.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\jd15.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\京东线上红票报文.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣清单正票-15000119270105897.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣清单正票.txt"), "utf-8");//没有问题 正常开票；

 //           content = FileUtils.readFileToString(new File("D:\\test\\jd.txt"), "utf-8");//没有问题 正常开票；
 //           content = FileUtils.readFileToString(new File("D:\\test\\jd-0710.txt"), "utf-8");
        	
//            content = FileUtils.readFileToString(new File("D:\\test\\测试报文\\error.txt"), "utf-8");//没有问题 正常开票；
...
//        String interfaceUrl ="http://10.1.23.193:8003/zzs_jdProxy/webservice/eInvWS?wsdl";
        String interfaceUrl ="http://127.0.0.1:8080/zzs_jdProxy/webservice/eInvWS?wsdl";
//        String interfaceUrl ="http://10.1.23.237:8080/zzs_jdProxy/webservice/eInvWS?wsdl";
//        String interfaceUrl ="http://10.1.1.56:8081/zzs_jdProxy/webservice/eInvWS?wsdl";
//        String interfaceUrl ="http://124.205.208.204:56080/zzs_jdProxy/webservice/eInvWS?wsdl";
//        String interfaceUrl ="http://103.237.6.96:8080/zzs_jdProxy/webservice/eInvWS?wsdl";
        String interfaceMethod = "eiInterface";
        String namespace = "http://ws.aisino.com/";
        String parameterName = "requestXml";
        Object[] invokeParam = new Object[] { requestXml };
        String responseXml = InvokeInterfaceTest.invokeWS(interfaceUrl,
