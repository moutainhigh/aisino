...
public class For_InvokeInterfaceTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String content = "";
        try {
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\商品编码折扣率0418.xml"), "utf-8");
            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣A4正票.txt"), "utf-8");
        } catch (IOException e) {
        ...
        contentString = content.replace(regex, "<FPQQLSH>"+System.currentTimeMillis()+"</FPQQLSH>");
        String regex1 = "<DDH></DDH>" ;
        contentString = contentString.replace(regex1, "<DDH>"+System.currentTimeMillis()+"</DDH>");
        String regex2 = "<BZ></BZ>" ;
        contentString = contentString.replace(regex2, "<BZ>订单号:"+System.currentTimeMillis()+"</BZ>");
