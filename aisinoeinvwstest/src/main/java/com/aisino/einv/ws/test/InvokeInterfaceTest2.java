...
public class InvokeInterfaceTest2 {
...
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣A4正票.txt"), "utf-8");//没有问题 正常开票；
 //           content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣清单正票.txt"), "utf-8");//没有问题 正常开票；
            ...
            content = FileUtils.readFileToString(new File("D:\\test\\jd2.txt"), "utf-8");//没有问题 正常开票；
        ...
        contentString = content.replace(regex, "<FPQQLSH>2"+System.currentTimeMillis()+"</FPQQLSH>");
        String regex1 = "<DDH></DDH>" ;
        contentString = contentString.replace(regex1, "<DDH>2"+System.currentTimeMillis()+"</DDH>");
        String regex2 = "<BZ></BZ>" ;
        contentString = contentString.replace(regex2, "<BZ>订单号:2"+System.currentTimeMillis()+"</BZ>");
...
//                + "<taxpayerId>15000119270105897</taxpayerId>"
        ...
        Object[] invokeParam = new Object[] { requestXml };
        String responseXml = InvokeInterfaceTest2.invokeWS(interfaceUrl,
