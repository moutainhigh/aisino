...
public class InvokeInterfaceTest11 {
...
//        	content = FileUtils.readFileToString(new File("D:\\test\\baowen.txt"), "utf-8");//报文项目金额计算关系有问题；
...
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣A4红票.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\新报文\\广州图书不带折扣清单正票.txt"), "utf-8");//没有问题 正常开票；

//            content = FileUtils.readFileToString(new File("D:\\test\\jdlp.txt"), "utf-8");//没有问题 正常开票；
            content = FileUtils.readFileToString(new File("D:\\test\\baowen20180820.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\总公司成品油报文.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\泰州大药房报文-hp.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\三亚机构报文.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\第11行折扣行税率不相等报文.txt"), "utf-8");//没有问题 正常开票；
//            content = FileUtils.readFileToString(new File("D:\\test\\150001196704113115.txt"), "utf-8");//没有问题 正常开票；
...
//                + "<taxpayerId>15000119270105897</taxpayerId>"
 ...
 //       String interfaceUrl ="http://127.0.0.1:8080/zzs_jdProxy/webservice/eInvWS?wsdl";
        ...
        Object[] invokeParam = new Object[] { requestXml };
        String responseXml = InvokeInterfaceTest11.invokeWS(interfaceUrl,
