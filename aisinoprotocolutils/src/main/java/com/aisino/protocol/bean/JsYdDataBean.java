...
public class JsYdDataBean {
	...
	/** full constructor */
	public JsYdDataBean(long id, String prover, String transver, String nsrsbh,
			String fjh, String reqtypeDm, String reqno, String clstatusDm,
			String cwms, Date writetime, Date receivetime, Blob jsdata,
			Blob yddata, int jsdatalen, int yddatalen, int crc) {
		this.id = id;
		this.prover = prover;
