...
import com.aisino.protocol.bean.FPKJJG;
 ...
 */
public class RESPONSE_FPKJJG extends com.aisino.protocol.bean.RESPONSE_BEAN {
    private String DSPTBM;
    private String FPSCLSH;
    private com.aisino.protocol.bean.FPKJJG[] FPKJJGS;
	...
	public com.aisino.protocol.bean.FPKJJG[] getFPKJJGS() {
		return FPKJJGS;
	}
