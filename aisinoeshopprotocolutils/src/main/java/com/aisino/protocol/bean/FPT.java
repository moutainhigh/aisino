...
public class FPT
{
	...
	private String ZT;
	/*
	 * add 2011-01-28 开票方式KPFS（00 自助终端 01 UKEY）
	 * VERSION 版本号
	 */
	private String KPFS;
	...
	public void setXXPZLB(String xxpzlb) {
		XXPZLB = xxpzlb;
	}
...
//	}
	...
	public void setZG_SWGY_DM(String zg_swgy_dm) {
		ZG_SWGY_DM = zg_swgy_dm;
	}
