...
public class ProXml_DSCLD {
	private final static Logger  log = Logger.getLogger(ProXml_DSCLD.class);
	/**
	 * 
	 * <p>
	 * 转码
	...
	public static String getXml(com.aisino.common.util.GlobalInfo globalInfo, ReturnStateInfo returnStateInfo, com.aisino.common.util.Data data){
	 ...
	 * @return
	 */
	public static String getXmlOuter(com.aisino.common.util.GlobalInfo globalInfo, ReturnStateInfo returnStateInfo, com.aisino.common.util.Data data){
		return getXml(globalInfo, returnStateInfo, data, false);
	}
	
	
	private static String getXml(com.aisino.common.util.GlobalInfo globalInfo, ReturnStateInfo returnStateInfo, com.aisino.common.util.Data data, boolean flag){
		String resData = "";
		try {
		Element root = new Element(com.aisino.common.util.XmlPar.ROOT_BASE);
		Namespace ns = Namespace.getNamespace(com.aisino.common.util.XmlPar.NS_ONE);
		root.addNamespaceDeclaration(ns);
		Namespace ns1 = Namespace.getNamespace("xsi", com.aisino.common.util.XmlPar.NS_TWO);
		root.addNamespaceDeclaration(ns1);
		Namespace ns2 = Namespace.getNamespace("schemaLocation", com.aisino.common.util.XmlPar.NS_THREE);
		root.addNamespaceDeclaration(ns2);
		Document doc = new Document(root);
		Element eRoot = doc.getRootElement();
		eRoot.setAttribute("version", com.aisino.common.util.XmlPar.VERSION_NO);
	
		// 全局信息
		Element eGlobalInfo = new Element(com.aisino.common.util.XmlPar.GLOBALINFO);
		Element eAppID = new Element(com.aisino.common.util.XmlPar.APPID);
		eAppID.setText(globalInfo.getAppId());
		eGlobalInfo.addContent(eAppID);
		Element eInterfaceCode;
		eInterfaceCode = new Element(com.aisino.common.util.XmlPar.INTERFACECODE);
		eInterfaceCode.setText(globalInfo.getInterfaceCode());
		eGlobalInfo.addContent(eInterfaceCode);
		Element ERequestCode = new Element(com.aisino.common.util.XmlPar.REQUESTCODE);
		ERequestCode.setText(globalInfo.getRequestCode());
		eGlobalInfo.addContent(ERequestCode);
		Element eRequestTime = new Element(com.aisino.common.util.XmlPar.REQUESTTIME);
		eRequestTime.setText(globalInfo.getRequestTime());
		eGlobalInfo.addContent(eRequestTime);
		Element eResponseCode;
		eResponseCode = new Element(com.aisino.common.util.XmlPar.RESPONSECODE);
		eResponseCode.setText(globalInfo.getResponseCode());
		eGlobalInfo.addContent(eResponseCode);
		Element eDataExchangeId = new Element(com.aisino.common.util.XmlPar.DATAEXCHANGEID);
		eDataExchangeId.setText(globalInfo.getDataExchangeId());
		eGlobalInfo.addContent(eDataExchangeId);
		Element eUserName = new Element(com.aisino.common.util.XmlPar.USERNAME);
		eUserName.setText(globalInfo.getUserName());
		eGlobalInfo.addContent(eUserName);
		Element ePassWord = new Element(com.aisino.common.util.XmlPar.PASSWORD);
		ePassWord.setText(globalInfo.getPassWord());
		eGlobalInfo.addContent(ePassWord);
		// 返回信息
		Element eReturnStateInfo = new Element(com.aisino.common.util.XmlPar.RETURNSTATEINFO);
		Element eReturnCode = new Element(com.aisino.common.util.XmlPar.RETURNCODE);
		eReturnCode.setText(returnStateInfo.getReturnCode());
		eReturnStateInfo.addContent(eReturnCode);
		Element eReturnMessage = new Element(com.aisino.common.util.XmlPar.RETURNMESSAGE);
		...
		// 交换数据
		Element eData = new Element(com.aisino.common.util.XmlPar.DATA);
		Element eDataDescription;
		eDataDescription = new Element(com.aisino.common.util.XmlPar.DATADESCRIPTION);
		Element eZipCode = new Element(com.aisino.common.util.XmlPar.ZIPCODE);
		String iszip="";
		...
		Element eEncryptCode = new Element(com.aisino.common.util.XmlPar.ENCRYPTCODE);
		eEncryptCode.setText(data.getEncryptCode());
		eDataDescription.addContent(eEncryptCode);
		Element eCodeType = new Element(com.aisino.common.util.XmlPar.CODETYPE);
		eCodeType.setText(data.getCodeType());
		eDataDescription.addContent(eCodeType);
		eData.addContent(eDataDescription);
		Element eContent = new Element(com.aisino.common.util.XmlPar.CONTENT);
		if(flag){
			String content=encodeData(data.getContent(), iszip, data.getEncryptCode(), globalInfo.getPassWord());
	...
	public static Map getInterface(String requestMessage,boolean flag) {
		Map map = new HashMap();
		com.aisino.common.util.GlobalInfo globalInfo = new com.aisino.common.util.GlobalInfo();
		try {
			...
			if (node != null && node.size() > 0) {
				for (int i = 0; i < node.size(); i++) {
					...
					if (e1.getName().equals(com.aisino.common.util.XmlPar.GLOBALINFO)) {
						globalInfo.setAppId(e1.getChild(com.aisino.common.util.XmlPar.APPID).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.APPID).getText());
						globalInfo.setInterfaceCode(e1.getChild(com.aisino.common.util.XmlPar.INTERFACECODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.INTERFACECODE).getText());
						globalInfo.setRequestCode(e1.getChild(com.aisino.common.util.XmlPar.REQUESTCODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.REQUESTCODE).getText());
						globalInfo.setRequestTime(e1.getChild(com.aisino.common.util.XmlPar.REQUESTTIME).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.REQUESTTIME).getText());
						globalInfo.setResponseCode(e1.getChild(com.aisino.common.util.XmlPar.RESPONSECODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.RESPONSECODE).getText());
						globalInfo.setDataExchangeId(e1.getChild(com.aisino.common.util.XmlPar.DATAEXCHANGEID).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.DATAEXCHANGEID).getText());
						globalInfo.setUserName(e1.getChild(com.aisino.common.util.XmlPar.USERNAME).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.USERNAME).getText());
						globalInfo.setPassWord(e1.getChild(com.aisino.common.util.XmlPar.PASSWORD).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.PASSWORD).getText());
						map.put(e1.getName(), globalInfo);
					}
					if (e1.getName().equals(com.aisino.common.util.XmlPar.RETURNSTATEINFO)) {
						ReturnStateInfo returneStateInfo = new ReturnStateInfo();
						returneStateInfo.setReturnCode(e1.getChild(com.aisino.common.util.XmlPar.RETURNCODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.RETURNCODE).getText());
						if (e1.getChild(com.aisino.common.util.XmlPar.RETURNMESSAGE).getText() != null&& !e1.getChild(com.aisino.common.util.XmlPar.RETURNMESSAGE).getText().equals("")) {
							returneStateInfo.setReturnMessage(decode(e1.getChild(com.aisino.common.util.XmlPar.RETURNMESSAGE).getText())==null?"":e1.getChild(com.aisino.common.util.XmlPar.RETURNMESSAGE).getText());
						} else {
							returneStateInfo.setReturnMessage("");
						}
						map.put(e1.getName(), returneStateInfo);
					}
					if (e1.getName().equals(com.aisino.common.util.XmlPar.DATA)) {
						com.aisino.common.util.Data data = new com.aisino.common.util.Data();
						data.setDataDescription(e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getText());
						data.setZipCode(e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.ZIPCODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.ZIPCODE).getText());
						data.setEncryptCode(e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.ENCRYPTCODE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.ENCRYPTCODE).getText());
						data.setCodeType(e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.CODETYPE).getText()==null?"":e1.getChild(com.aisino.common.util.XmlPar.DATADESCRIPTION).getChild(com.aisino.common.util.XmlPar.CODETYPE).getText());
						log.debug(e1.getChild(com.aisino.common.util.XmlPar.CONTENT).getText());
						if(flag){
							String content=decodeData(e1.getChild(com.aisino.common.util.XmlPar.CONTENT).getText(), data.getZipCode(), data.getEncryptCode(), globalInfo.getPassWord());
							data.setContent(content);
						}else{
							data.setData(e1.getChild(com.aisino.common.util.XmlPar.CONTENT).getText());
						}
...
//				temp_coutnent = decode(temp_coutnent);
				...
				if ("1".equals(zipCode)) {
					temp_coutnent = com.aisino.common.util.GZipUtils.decompress(temp_coutnent);
				}
...
//						SJCaCryptUtil sjutil = new SJCaCryptUtil(FileUtils.readFileToByteArray(new File(StaticConstant.CA_TEST_PATH+"\\qyCA\\UserCert.der")),false);
...
//					}
    ...
    public static String encodeData(String org, String zipCode, String encryptCode, String password) {
...
//                                FileUtils.readFileToByteArray(new File(StaticConstant.CA_TEST_PATH + "\\CorpCA\\UserCert.der")));
//                        temp_content = qyutil.encrypt(temp_content);
//                    }
                }
                if ("1".equals(zipCode)) {
                    temp_content = com.aisino.common.util.GZipUtils.compress(temp_content);
                }
...
//        }
     ...
     * @param data
     */
	public static void getGlobalInfo(Map map, com.aisino.common.util.GlobalInfo globalInfo) {
		Password password;
		if(map.get(com.aisino.common.util.XmlPar.MAP_KEY_ZCM)==null || map.get(com.aisino.common.util.XmlPar.MAP_KEY_ZCM).toString().equals("")){
			password = PassWordCheck.passWordCreate(StaticConstant.DEFAULTZCM);
		}else{
			password = PassWordCheck.passWordCreate(map.get(com.aisino.common.util.XmlPar.MAP_KEY_ZCM).toString());
		}
        globalInfo.setAppId(com.aisino.common.util.XmlPar.WLFP);
        globalInfo.setInterfaceCode((String) map.get(com.aisino.common.util.XmlPar.MAP_KEY_YWBM));
        globalInfo.setPassWord(password.getSjm()+password.getPass());
        globalInfo.setRequestTime(ProXml_DSCLD.getCurDate("yyyyMMddHHmmss"));
        globalInfo.setResponseCode(com.aisino.common.util.XmlPar.SJBM);
        globalInfo.setRequestCode((String) map.get(com.aisino.common.util.XmlPar.MAP_KEY_DSPTBM));
        globalInfo.setUserName((String) map.get("dsptbm"));
//        (String) map.get(XmlPar.MAP_KEY_YWBM) +
        globalInfo.setDataExchangeId((String) map.get(com.aisino.common.util.XmlPar.MAP_KEY_DSPTBM) +  ProXml_DSCLD.getCurDate("yyyyMMdd") + getRdom(9));
    }
	
	public static com.aisino.common.util.GlobalInfo getGlobalInfo(String busiType, String dsptbm, Date requestTime) {
		com.aisino.common.util.GlobalInfo globalInfo=new com.aisino.common.util.GlobalInfo();
        globalInfo.setAppId(com.aisino.common.util.XmlPar.WLFP);
	...
	public static com.aisino.common.util.GlobalInfo getGlobalInfo(String busiType, String dsptbm, String dataExId) {
		com.aisino.common.util.GlobalInfo globalInfo=new com.aisino.common.util.GlobalInfo();
        globalInfo.setAppId(com.aisino.common.util.XmlPar.WLFP);
        globalInfo.setInterfaceCode(busiType);
        globalInfo.setRequestTime(ProXml_DSCLD.getCurDate("yyyyMMddHHmmss"));
	...
	public static LogBean getLogBean(Map map,String type) {
		...
		com.aisino.common.util.GlobalInfo globalInfoR = (com.aisino.common.util.GlobalInfo) map.get(com.aisino.common.util.XmlPar.GLOBALINFO);
		ReturnStateInfo returnStateInfoR = (ReturnStateInfo) map.get(com.aisino.common.util.XmlPar.RETURNSTATEINFO);
		...
		if(type.equals("response")){
			logBean.setReturnMessage(ProXml_DSCLD.encode(returnStateInfoR.getReturnMessage()));
		}
		return logBean;
		}catch(Exception ce)
		{
			...
			ce.printStackTrace();
			logBean.setAppId(com.aisino.common.util.XmlPar.WLFP);
			...
			if(type.equals("response"))
			{
				logBean.setReturnMessage(ProXml_DSCLD.encode("获取请求或响应的报文数据失败，请检查报文数据！"));
			}
			return logBean;
		}
	}
	...
	public static DataLogBean getDataLogBean(Map map) {
		...
		try{
		com.aisino.common.util.Data dataR = (com.aisino.common.util.Data) map.get(com.aisino.common.util.XmlPar.DATA);
		com.aisino.common.util.GlobalInfo globalInfoR = (GlobalInfo) map.get(XmlPar.GLOBALINFO);
