...
public final class PKCS7 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final byte[] encodeData2 = pkcs7Client.pkcs7Encrypt(source2, FileUtils.readFileToByteArray(new File(CaConstant.getProperty("CLIENT_DECRYPTCER"))));
