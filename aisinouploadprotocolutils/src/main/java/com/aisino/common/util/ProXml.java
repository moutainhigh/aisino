...
public class ProXml {
    ...
    private static String getXml(GlobalInfo globalInfo, ReturnStateInfo returnStateInfo, Data data, boolean flag) {
        String resData = "";
        try {
...
//						if(e1.getChild(XmlPar.SJZSBH) != null){
//							data.setSjZsbh(e1.getChild(XmlPar.SJZSBH).getText()==null?"":e1.getChild(XmlPar.SJZSBH).getText());
//						}else{
//							data.setSjZsbh("");
//						}
//						if(e1.getChild(XmlPar.QYZSBH) != null){
//							data.setQyZsbh(e1.getChild(XmlPar.QYZSBH).getText()==null?"":e1.getChild(XmlPar.QYZSBH).getText());
//						}else{
//							data.setQyZsbh("");
//						}
...
//		GlobalInfo log = ProXml.getGlobalInfo("123123","123123", "123412312312312312");
...
//		FileUtils.writeByteArrayToFile(new File("c:\\abc.xml"), xml.getBytes("UTF-8"));
        String xml = new String(FileUtils.readFileToByteArray(new File("c:\\abc.xml")), "UTF-8");
